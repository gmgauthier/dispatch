...
AboutDialog::AboutDialog(Gtk::Window& parent)
    : Gtk::Dialog("About Dispatch", parent, true)
{
  set_resizable(false);
  ...
  title->set_markup("<b>Dispatch " VERSION "</b>");
  box->pack_start(*title, Gtk::PACK_SHRINK);

  auto* line = Gtk::manage(new Gtk::Label(
      "Dispatch — an Outlook Express-shaped feed reader for The Lunduke Computer Operating System. "
      "Mail mode is coming later, in this window."));
