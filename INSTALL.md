...
```
sudo apt install ./dist/dispatch_0.2.0-1_amd64.deb
```
...
Launch from the menu or `dispatch`. Config is `~/.config/dispatch/dispatch.ini`. Mail is under `~/.local/share/dispatch/mail/`.
